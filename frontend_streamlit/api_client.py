...
class RankingApiClient:
    """HTTP client aligned with FastAPI routers in ``api/``."""

    # Reference data (periods list, sectors, DB metrics) lives under this prefix.
    ...
    def list_periods(self) -> list[str]:
        payload = self._request("GET", f"{self._REFERENCE}/periods")
    ...
    def list_metrics(self) -> list[dict[str, Any]]:
        ...
        payload = self._request("GET", f"{self._REFERENCE}/db/metrics/available")
    ...
    def list_db_metrics(self) -> list[dict[str, Any]]:
        ...
        payload = self._request("GET", f"{self._REFERENCE}/db/metrics")
        return payload.get("metrics", [])
    ...
    def list_sectors(self) -> list[str]:
        payload = self._request("GET", f"{self._REFERENCE}/sectors")
        return payload.get("sectors", [])

    def list_industries(self) -> list[str]:
        payload = self._request("GET", f"{self._REFERENCE}/industries")
